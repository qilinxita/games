...
game.prototype={
    ...
    again:function(){
        ...
        //var step1=document.getElementsByClassName('mes')[0].getElementsByTagName('span')[0];
    ...
    move2:function(){
        for (var i = 0; i < that.span.length; i++) {
            ...
            if(tops>that.height){
                ...
                var ss=document.getElementById("shengming")
                console.log(ss)
                ss.innerHTML=--that.die;
                if(that.die==0){
                    var fail=document.getElementsByClassName("fail")[0];
                    var score=document.getElementById("score");
                    var again=document.getElementById("again");
